...
(function (CONTROL_CODE) {
    CONTROL_CODE[CONTROL_CODE["READ"] = 3] = "READ";
    CONTROL_CODE[CONTROL_CODE["WRITE"] = 6] = "WRITE";
})(CONTROL_CODE || (CONTROL_CODE = {}));
var CMD;
(function (CMD) {
    CMD[CMD["READ_TEMP"] = 0] = "READ_TEMP";
    CMD[CMD["SET_TEMP"] = 1] = "SET_TEMP";
    CMD[CMD["OPEN"] = 2] = "OPEN";
    CMD[CMD["CLOSE"] = 3] = "CLOSE";
    CMD[CMD["READ_ADDR"] = 4] = "READ_ADDR";
})(CMD || (CMD = {}));
let AcService = class AcService {
    constructor() {
        this.findDeviceIdxByProprty = (value, proprty = 'ip') => this.devices.findIndex((device) => device[proprty] === value);
        this.register();
        this.tcpServer();
    }
    register() {
...
exports.AcService = AcService = __decorate([
